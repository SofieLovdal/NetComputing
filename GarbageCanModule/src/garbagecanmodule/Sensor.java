 ...
 * @author Sofie Lovdal
 * 
 * Sensor connected to a garbage can which senses when a new event has happened.
 */
public class Sensor implements Runnable {
    ...
    private void simulateEvent() {
        ...
        /* If the garbage can is full or malfunctioning, they can can not be used any more.
