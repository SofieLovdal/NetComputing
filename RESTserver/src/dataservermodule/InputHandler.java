 ...
 * 
 * This class communicates with the RabbitMQ message queue.
 * It pops messages and inserts them in the message queue of the server.
 */
public class InputHandler extends Thread {
    ...
    public InputHandler(DataServer server) {
        ...
        this.factory.setHost("10.19.0.136");
        this.connectToMQ();
    }
